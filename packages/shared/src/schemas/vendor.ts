...
export const vendorAccountTypeSchema = z.enum(["individual", "company"]);
...
export function emptyVendorForm(
  accountType: VendorAccountType = "company",
): VendorFormValues {
  return {
    accountType,
    name: "",
...
export function vendorFormValuesToInput(
  values: VendorFormValues,
): CreateVendorInput {
  return createVendorSchema.parse({
    ...values,
